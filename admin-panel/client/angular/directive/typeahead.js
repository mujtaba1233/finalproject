vulusionApp.directive('sfTypeahead', function () {
	return {
		...
		link: function (scope, element, attrs, ngModel) {
			...
			initialize();
			console.log('directive',scope.datasets);
			...
			element.bind('typeahead:selectedForEndUser', function(object, suggestion, dataset) {
				console.log("typeahead:selectedForEndUser");
				updateScope(object, suggestion, dataset);
				scope.$emit('typeahead:selectedForEndUser', suggestion, dataset);
			});
